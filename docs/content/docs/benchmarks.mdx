...
| `fts-adaptive` | `0.6133` | `533.3` | `0.6290` | `0.0745` | `0.6386` | `0.1771` | `1.0000` |
...
The first untouched official 100K smoke covered 188 messages, 63,411 observed whitespace tokens, 20 probing questions across all ten categories, and 53/53 resolved source references. The reusable trace was 31 KB and the complete proof directory was about 700 KB. This is local evidence-recall instrumentation with `public_benchmark_claim: false`, not the official model-judged BEAM score.
...
- BEAM: expand the verified 100K adapter smoke into isolated 500K, 1M, and 10M runs before making scale-quality claims.
