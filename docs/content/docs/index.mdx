...
- Use [Consolidation Review](/docs/consolidation-preview) to inspect verified source sets, confirm one candidate, and materialize a reversible quarantined summary without changing agent memory.
