...
Current post-release L5 candidate:
...
- Next acceptance is a simultaneous Codex plus Claude Code attach against one governed scope, followed by host-confirmed identity only where an agent host provides a trustworthy session identifier.
