...
| Website / Docs | Landing, proof page, docs, changelog | 100% for v0.1.17 | Release copy, agent setup/session UX, Rooms behavior, governed Reason premises, transfer safety, benchmark boundary, and ActiveGraph pack version are synchronized and live; production install reports zero vulnerabilities | Retain dependency and release-surface canaries |
